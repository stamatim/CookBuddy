...
import com.example.primaryfolder.cookbuddy.activities.RegisterUser;
...
public class SessionManager {
    ...
    private static final String PREF_NAME = "CookBuddyUserLogin";
    ...
    public void checkLogin(){
        ...
        if(!this.isLoggedIn()){
            ...
            Intent i = new Intent(context, RegisterUser.class);
